...
public class UpdateManager {
	...
	//注意要获取到本地APP的版本号,需要在这里修改一下自己app的包名,否则获取不到版本号
	private static final String packagename="com.wd.weidu";
	...
	private Handler mGetVersionHandler = new Handler(){
		public void handleMessage(Message msg) {
			...
			System.out.println(ver.version_code);
	...
	protected boolean isUpdate() {
		...
		try {
			...
			localVersion = mContext.getPackageManager().getPackageInfo(packagename, 0).versionCode;
